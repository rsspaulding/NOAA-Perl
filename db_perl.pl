    if ($numph > 0) {
                    ...
                    $pKa=(1245.69/($TempFinal+273.15))+3.8275+(0.0021*(35-$Salinity)); #one value per line


                    # following value is one per line

                    # Molar absorptivities
                    $Ea434 = $ea434-(26*($TempFinal-24.788));
                    $Ea578 = $ea578+($TempFinal-24.788);
                    $Eb434 = $eb434+(12*($TempFinal-24.788));
                    $Eb578 = $eb578-(71*($TempFinal-24.788));
                    $e1=$Ea578/$Ea434;
                    $e2=$Eb578/$Ea434;
                    $e3=$Eb434/$Ea434;
                    ...
                    for ($ii=0;$ii<22;$ii++) {
                       ...
                       if ($i434 == 0 || $i578 == 0 || $a578blank == 'bad' || $a434blank == 'bad') {
                         ...
                         $HI=(($a434*$Eb578)-($a578*$Eb434))/(($Ea434*$Eb578)-($Eb434*$Ea578)); #22 values
                         $I=(($a578*$Ea434)-($a434*$Ea578))/(($Ea434*$Eb578)-($Eb434*$Ea578));  #22 values
